...
public class VoiceAppFirebaseService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            VoiceAppLogger.debug(TAG, "Message Notification Body: " + remoteMessage.getNotification().getBody());
        } else {
    ...
    private void processPushNotification(Map<String, String> remoteData) {
        ...
        final PushNotificationData pushNotificationData = mapper.convertValue(remoteData, PushNotificationData.class);
        ...
        if (!subscriberName.equals(pushNotificationData.getSubscriberName())) {
            VoiceAppLogger.error(TAG, "User ID in push notification: " + pushNotificationData.getSubscriberName() + " Current User Id: " + subscriberName);
            return;
        }
...
//        Intent intent = new Intent(this,VoiceAppService.class);
       ...
       /* intent.putExtra("hostname", hostname);
        ...
        VoiceAppService voiceAppService = VoiceAppService.getInstance(getApplicationContext());
        voiceAppService.parsingPushNotification(pushNotificationData.getPayloadVersion(), pushNotificationData.getPayload(), true, pushNotificationData.getSubscriberName(), hostname, subscriberToken, accountSid);
